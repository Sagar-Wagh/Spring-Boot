...
import com.techm.services.ConverterService;
import com.techm.services.GifEncoderService;
import com.techm.services.VideoDecoderService;
...
public class AutoConfiguration {
   ...
   private JustGifItProperties properties;
    ...
    @Bean
    @ConditionalOnProperty(prefix = "com.techm.justgifit",name="create-result-dir")
	...
	public static class WebConfigure
	{
		...
		@Bean
		@ConditionalOnProperty(prefix = "com.techm.justgifit" ,name="optimize")
